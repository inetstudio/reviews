...
namespace InetStudio\Reviews\Sites\Repositories;
 ...
 */
class SitesRepository implements SitesRepositoryContract
{
    /**
     ...
     * @return SiteModelContract
     */
    public function getItemByID(int $id): SiteModelContract
    {
    ...
    {
        $defaultColumns = ['id', 'name', 'alias', 'link', 'is_active'];
