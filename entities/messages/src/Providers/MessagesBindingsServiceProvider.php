...
class MessagesBindingsServiceProvider extends ServiceProvider
{
    ...
    */
    public $bindings = [
        ...
        'InetStudio\Reviews\Messages\Contracts\Observers\MessageObserverContract' => 'InetStudio\Reviews\Messages\Observers\MessageObserver',
        ...
        'InetStudio\Reviews\Messages\Contracts\Services\Back\MessagesObserverServiceContract' => 'InetStudio\Reviews\Messages\Services\Back\MessagesObserverService',
